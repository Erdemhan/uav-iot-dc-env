...
if __name__ == "__main__":
    ...
    algo = config.build()
    print(f"Starting PPO-LSTM training for scenario {args.scenario} ({GlobalConfig.TRAIN_ITERATIONS} iterations)...")
    ...
    print(f"Saving final PPO-LSTM model checkpoint to {ckpt_dir}...")
    ...
    algo.stop()
    print("PPO-LSTM Training Completed.")
    ray.shutdown()
