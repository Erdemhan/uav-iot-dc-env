...
if __name__ == "__main__":
    ...
    algo = config.build()
    print(f"Starting PPO training for scenario {args.scenario} ({GlobalConfig.TRAIN_ITERATIONS} iterations)...")
    ...
    print(f"Saving final PPO model checkpoint to {ckpt_dir}...")
